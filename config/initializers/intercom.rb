IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "i0kinox8"

  # == Intercom secret key 
  # This is required to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  config.api_secret = "aFfMz-K_w13DsPsa3Sg6MeLVhmP0Sn6kAWppQk0X"
  ...
  #
  config.api_key = "0143666a53e0f6e7afa891bec76ec62741729d64"
