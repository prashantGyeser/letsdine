== Angularjs with devise rails example
...
== Setting up and using Mandrill SMTP headers
http://stackoverflow.com/questions/16172562/rails-delayed-job-argument-error-with-mailer
...
== Heroku pull and push database from heroku and to heroku from a localmachine
https://github.com/ddollar/heroku-pg-transfer

== Getting records by month, week etc
